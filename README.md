# Cognito Branch
This branch adds a demo page, controller, and changes to the main web app that show how to use Amazon Cognito to store user data and authenticate users from the browser. Cognito lets you add authentication and secure data storage to a web app without any changes to your backend code.
